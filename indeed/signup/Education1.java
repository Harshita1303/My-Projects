...
public class Education1 extends JFrame implements ActionListener{
    
    public JTextField schoolNameTextField, schoolName1TextField, percentageTextField, percentage1TextField, ypass1TextField, ypass2TextField, board1TextField, board2TextField;
    ...
    public Education1(){
        ...
        //Personal Details
        JLabel personalDetails = new JLabel("Page 2: Education Details");
        ...
        //name
        JLabel label1 = new JLabel("Class 10th Details: ");
        label1.setFont(new Font("Raleway", Font.BOLD,20));
        label1.setBounds(80, 60, 500, 100);
        add(label1);
                
         //fathers name
        JLabel degree = new JLabel("School Name: ");
        ...
        JLabel ypass1 = new JLabel("Year Passing: ");
        ...
        JLabel board = new JLabel("School Board: ");
        ...
        //Marital Status
        JLabel status = new JLabel("Class 12th Details: ");
        status.setFont(new Font("Raleway", Font.BOLD,20));
        status.setBounds(80, 210, 500, 100);
        add(status);
        
        //Address
        JLabel sname = new JLabel("School Name: ");
        ...
        //City
        JLabel per1 = new JLabel("Percentage: ");
        ...
        add(percentage1TextField);
          ...
          //state
        JLabel state = new JLabel("Year Passing");
        ...
        add(ypass2TextField);
          ...
          //pincode
        JLabel board2 = new JLabel("School Board: ");
        board2.setFont(new Font("Raleway", Font.BOLD,15));
        board2.setBounds(80, 330, 500, 100);
        add(board2);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String board2 = board2TextField.getText();
