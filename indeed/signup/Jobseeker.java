...
public class Jobseeker extends JFrame implements ActionListener{
    
    public long random;
    public JTextField roleTextField,nameTextField, fatherNameTextField, emailTextField, phoneTextField,addressTextField, stateTextField, cityTextField, pincodeTextField;
    ...
    public void actionPerformed(ActionEvent e){
        ...
        try{
                ...
                String query = "insert into EmpDetails values('"+role+"','"+name+"','"+fname+"','"+gen+"','"+email+"','"+phone+"','"+address+"','"+city+"','"+state+"')";
